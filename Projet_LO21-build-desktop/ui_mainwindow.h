...
**
** Created: Wed May 23 21:42:09 2012
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_MOD, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_COS, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_COSH, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_SIN, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_SINH, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_TAN, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_TANH, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_POW, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_FACT, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_LN, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_LOG, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_INV, SLOT(setDisabled(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), pushButton_SQRT, SLOT(setDisabled(bool)));
